    ...
    return (
        <section className='relative bg-[url("/images/caseStudyHero.png")] bg-no-repeat  bg-cover py-28 lg:py-64'>
            ...
            <div className='max-w-[1400px] mx-auto px-4 sm:px-6 relative z-10 space-y-4'>
                <p className='text-sm md:text-lg text-white flex items-center gap-4 justify-center'><Link href={'/'}>Home</Link> <RiArrowRightSLine className='text-primary text-2xl' /><Link href={'/case-study'}>Case-Study</Link></p>
