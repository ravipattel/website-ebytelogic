...
},
{
  ...
  author: "Admin",
  date: "13 May, 2025",
  highlights: ["SRT", "RIST", "RTMP", "latency", "contribution"],
},
{
  ...
  author: "Admin",
  date: "24 April, 2025",
  highlights: ["embedded systems", "trends", "hardware", "software"],
},
{
  category: "NDI Workflows",
  id: "ndi-in-hybrid-ip-sdi-workflows",
  title: "NDI in Hybrid IP/SDI Workflows: What Product Teams Must Know",
  image: NdiPng,
  author: "Admin",
  date: "18 Jan, 2025",
  highlights: ["NDI", "IP", "SDI", "hybrid workflows", "broadcast"],
},
{
  ...
  author: "Admin",
  date: "18 Sep, 2025",
  highlights: ["Buildroot", "Yocto", "video devices", "embedded linux"],
},
{
  category: "Linux BSP",
  ...
  author: "Admin",
  date: "01 Feb, 2025",
  highlights: ["Linux BSP", "boot time", "first frame", "optimization"],
},
{
  ...
  highlights: ["CEA-608", "CEA-708", "DTVCC", "Line21", "caption conversion"],
},
{
  ...
  author: "Admin",
  date: "26th June, 2025",
  highlights: ["PTP", "SMPTE ST 2110", "timing", "synchronization", "IP video"],
},
{
  category: "Streaming Protocols",
  ...
  author: "Admin",
  date: "12 Jan, 2025",
  highlights: ["protocol switching", "frame drops", "debugging", "latency"],
},
{
  category: "FFmpeg & Sync",
  id: "ffmpeg-filters-frame-pacing-lip-sync",
  title: "FFmpeg Filters for Broadcast-Grade Sync, Frame Pacing, and Lip-Sync",
  image: ffmpegPng,
  author: "Admin",
  date: "08 J, 2025",
  highlights: ["FFmpeg", "lip sync", "frame pacing", "broadcast", "filters"],
},
{
  ...
  author: "Admin",
  date: "5 Sep, 2025",
  highlights: ["glass-to-glass latency", "measurement", "tools", "pitfalls"],
},
{
  ...
  author: "Admin",
  date: "19 Aug, 2025",
  highlights: ["edge encoders", "rugged design", "thermal", "power", "network"],
},
{
  ...
  author: "Admin",
  date: "08 July, 2025",
  highlights: ["automated QA", "gst-validate", "tracers", "soak tests", "live video"],
},
{
  category: "Secure Streaming",
  id: "secure-streaming",
  title: "Secure Streaming: Hardening SRT, SRTP, TLS & Key Management",
  image: SecurePng,
  author: "Admin",
  date: "20 April, 2025",
  highlights: ["secure streaming", "SRT", "SRTP", "TLS", "key management"],
},
{
  category: "Hardware Acceleration",
  id: "hardware-accelerated-transcoding-on-jetson-i.MX",
  title: "Hardware-Accelerated Transcoding on Jetson & i.MX: What Actually Matters",
  image: HardwarePng,
  author: "Admin",
  date: "22 Sep, 2025",
  highlights: ["hardware acceleration", "Jetson", "i.MX", "transcoding", "video processing"],
}
];
