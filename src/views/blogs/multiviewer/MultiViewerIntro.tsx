...
const MultiViewerIntro = ({ data }) => {
    ...
    return (
        <section id={introData?.id} className="px-4 md:px-6 py-8 bg-slate-50">
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-8">{introData?.title}</h2>
            <div className="mb-12">
                    ...
                    return (
                        <div key={index} className="bg-gray-50 rounded-md p-6 border border-gray-200">
                            <div className="flex items-center mb-4">
                                ...
                                <h3 className="font-serif text-lg md:text-xl font-semibold">{tech.name}</h3>
                            </div>
