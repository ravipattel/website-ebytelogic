                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-10">
                            ...
                            <div className="xl:col-span-5 md:col-span-1 flex flex-wrap justify-start lg:justify-center gap-4">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-sm text-gray-600">
                                        <li onClick={() => router.push(`/services/embedded-software`)} className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />Embedded App Development</li>
                                        <li onClick={() => router.push(`/services/linux-bsp-android`)} className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />Linux BSPs & Hardware Bring-Up</li>
                                        ...
                                        <li onClick={() => router.push(`/services/iot-integration`)} className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />IoT & Cloud Integration</li>
                                        <li onClick={() => router.push(`/services/qa-validation`)} className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />Embedded QA & Test Automation</li>
