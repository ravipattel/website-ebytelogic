...
const Subscribe = () => {
    ...
    return (
        <section className="max-w-[1400px] mx-auto pb-16 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-0 items-center p-8 shadow-2xl rounded-2xl border-t-2 border-primary">
