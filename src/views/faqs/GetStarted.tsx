    ...
    return (
        <div className='relative bg-[url("/images/getStarted.jpg")] py-28 lg:py-44 bg-bottom bg-cover'>
            ...
            <div className='max-w-[1400px] mx-auto px-4 sm:px-6 relative z-10 text-center'>
                <h2 className='text-2xl sm:text-[34px] font-semibold text-white leading-tight max-w-2xl mx-auto'>Still have a question?</h2>
                <p className='text-[#FFFFFFCC] text-sm md:text-base mt-4 mb-10 max-w-2xl mx-auto'>{`Our team is happy to help. Whether it's technical feasibility, project estimation, or solution
