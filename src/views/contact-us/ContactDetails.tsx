            ...
            <div className='max-w-[1400px] py-28 mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-10 items-center'>
                ...
                <div>
                    <div>
                        ...
                        {`We're here to answer your questions and help you achieve your goals. Whether you need support, have inquiries or want to discuss a project, feel free to reach out to our team anytime.`}
                        </p>
                    </div>
